          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div className="section-title pt-4">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipreiscing elit.
                  Lacus penatibus tincidunt
                </p>
              </div>
            </div>
              ...
              <div className="section-title">
                ...
                <div className="content mb-0 mt-4">
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Consv allis quam aliquet integer eget magna ullam corper
                    intesager peent esque urna. Ac eu fringilla intea dger egadv
                    estas ut. Sed vulutate aenean nunc quis a urna morbi id
                    vitae. Vulpuate nisl
                  </p>
                  <p>
                    sed morbi sit ut placerat eges aeftas et. Pellen tesque
                    tristisque magnis augue gravida pulvinar placerat. Tellus
                    massa pretra scelerisque leo. In volutpat arcu nunc nisl et,
                    viverra faucisfbus egestas. In habitasse sagittis, convallis
                    ut commodo amet, odio sagittis. Maecenas massa turpis duis
                    felis, massa. Morbi feugiat.
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <div className="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                      <div className="image-block text-center">
                        <img
                          loading="lazy"
                          decoding="async"
                          src={require("../images/payment-info.png")}
                    ...
                    <div className="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                      <div className="image-block text-center">
                        <img
                          loading="lazy"
                          decoding="async"
                          src={require("../images/illustration-2.png")}
                    ...
                    <div className="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                      <div className="image-block text-center">
                        <img
                          loading="lazy"
                          decoding="async"
                          src={require("../images/illustration-1.png")}
                          alt="How Do I Repay?"
                          className="img-fluid"
                        />
                      </div>
              ...
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  <img
                    loading="lazy"
                    decoding="async"
                    src={require("../images/testimonials/01.jpg")}
              ...
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  <img
                    loading="lazy"
                    decoding="async"
                    src={require("../images/testimonials/02.jpg")}
                    alt="Arlene McCoy"
                    className="img-fluid"
                    width="65"
                    height="66"
              ...
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  <img
                    loading="lazy"
                    decoding="async"
                    src={require("../images/testimonials/03.jpg")}
                    alt="Marvin McKinney"
                    className="img-fluid"
                    width="65"
                    height="66"
              ...
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  <img
                    loading="lazy"
                    decoding="async"
                    src={require("../images/testimonials/04.jpg")}
                    alt="Devon Lane"
                    className="img-fluid"
                    width="65"
                    height="66"
              ...
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  <img
                    loading="lazy"
                    decoding="async"
                    src={require("../images/testimonials/05.jpg")}
                    alt="Bessie Cooper"
                    className="img-fluid"
                    width="65"
                    height="66"
              ...
              <div className="shadow rounded bg-white p-4 mt-4">
                <div className="d-block d-sm-flex align-items-center mb-3">
                  <img
                    loading="lazy"
                    decoding="async"
                    src={require("../images/testimonials/06.jpg")}
                    alt="Kathryn Murphy"
                    className="img-fluid"
                    width="65"
                    height="66"
      ...
      {/* <section className="section">
        <div className="container">
          <div className="row justify-content-center">
            ...
            <div className="col-lg-6">
              <div
                className="accordion shadow rounded py-5 px-0 px-lg-4 bg-white position-relative"
                id="accordionFAQ"
              >
                <div className="accordion-item p-1 mb-2">
                  ...
                  <div
                    id="collapse-ebd23e34fd2ed58299b32c03c521feb0b02f19d9"
                ...
                <div className="accordion-item p-1 mb-2">
                  ...
                  <div
                    id="collapse-a443e01b4db47b3f4a1267e10594576d52730ec1"
                ...
                <div className="accordion-item p-1 mb-2">
                  ...
                  <div
                    id="collapse-4b82be4be873c8ad699fa97049523ac86b67a8bd"
                    className="accordion-collapse collapse border-0 "
                ...
                <div className="accordion-item p-1 mb-2">
                  <h2
                    ...
                    aria-expanded="false"
                    aria-controls="collapse-3e13e9676a9cd6a6f8bfbe6e1e9fc0881ef247b3"
                  >
                    Do you provide loans to military personnel?
                  </h2>
                  <div
                    id="collapse-3e13e9676a9cd6a6f8bfbe6e1e9fc0881ef247b3"
                    className="accordion-collapse collapse border-0 "
                ...
                <div className="accordion-item p-1 mb-2">
                  <h2
                    ...
                    aria-expanded="false"
                    aria-controls="collapse-0c2f829793a1f0562fea97120357dd2d43319164"
                  >
                    Can I remove footer credit purchase ?
                  </h2>
                  <div
                    id="collapse-0c2f829793a1f0562fea97120357dd2d43319164"
                    className="accordion-collapse collapse border-0 "
                ...
                <div className="accordion-item p-1 mb-2">
                  ...
                  >
                    What is the difference the free versions?
                  </h2>
                  <div
                    id="collapse-8fe6730e26db16f15763887c30a614caa075f518"
                    className="accordion-collapse collapse border-0 "
