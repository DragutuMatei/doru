          ...
          <div className="row justify-content-center align-items-center">
            ...
            <div className="col-lg-4 mt-5 mt-lg-0">
              <img
                loading="lazy"
                decoding="async"
                src={require("../images/about/team-1.jpg")}
          ...
          <div className="row justify-content-around">
            <div className="col-lg-5">
              ...
              <p className="lead">
                ...
                information lorem ipsums sitamets.
              </p>
            ...
            <div className="col-lg-5">
              ...
              <p className="lead">
                Our loan sanction is one of the quicke with eas documentation
                and doorstep lorem ipsum serviceullam dolor sitisi.
              </p>
              <div className="content">
                <ul>
              ...
              <div className="row position-relative gy-4">
                <div className="icon-box-item col-md-6">
                  <div className="block bg-white">
                    ...
                    <h3 className="mb-3">Authentic</h3>
                    <p className="mb-0">
                      Lorem ipsum dolor sit aamet, ctetur adsipis cing elit.
                      Lacaus
                    </p>
                  </div>
                </div>
                <div className="icon-box-item col-md-6">
                  <div className="block bg-white">
                    ...
                    <h3 className="mb-3">Empathetic</h3>
                    <p className="mb-0">
                      Lorem ipsum dolor sit aamet, ctetur adsipis cing elit.
                      Lacaus
                    </p>
                ...
                <div className="icon-box-item col-md-6">
                  <div className="block bg-white">
                    ...
                    <h3 className="mb-3">All Improving</h3>
                    <p className="mb-0">
                      Lorem ipsum dolor sit aamet, ctetur adsipis cing elit.
                      Lacaus
                    </p>
              ...
              <div className="section-title ps-0 ps-lg-5">
                ...
                <div className="content">
                  <p>
                    ...
                    intesager peent esque urna. Sed vulutate aenean nunc quis a
                    urna morbi id vitae. Vulpuate nisl
                  </p>
                  <p>
              ...
              <div className="card bg-transparent border-0 text-center">
                <div className="card-img">
                  <img
                    loading="lazy"
                    decoding="async"
                    src={require("../images/about/team-2.jpg")}
                    alt="Claire Simmmons"
                    className="rounded w-100"
                    width="300"
                    height="333"
              ...
              <div className="card bg-transparent border-0 text-center">
                <div className="card-img">
                  <img
                    loading="lazy"
                    decoding="async"
                    src={require("../images/about/team-3.jpg")}
                    alt="Leslie Pena"
                    className="rounded w-100"
                    width="300"
                    height="333"
