        ...
        <div className="container">
          <div className="row">
            <div className="col-8 mx-auto text-center">
              <h2 className="mb-3 text-capitalize">Blog</h2>
              <ul
          ...
          <div className="row">
                      ...
                      <div className="pt-4">
                        ...
                        <h2 className="h4">
                          <Link className="text-black" to="/blog/1">
                            Elements That You Can Use To Create A New Post On
                            This Template.
                          </Link>
                        </h2>
                        <p>
                          Heading example Here is example of hedings. You can
                          use this heading by following …
                        </p>{" "}
                        <Link
                          to="/blog/1"
                          className="text-primary fw-bold"
                    ...
                    <article className="blog-post">
                      ...
                      <div className="pt-4">
                        ...
                        <p>
                          ...
                          From exciting startups to global …
                        </p>{" "}
                        <Link
                          to="/blog/1"
                          className="text-primary fw-bold"
                      ...
                      <nav className="mb-md-50">
                        <ul className="pagination justify-content-center">
                          <li className="page-item active ">
                            <Link to="blog.html" className="page-link">
                              1
                            </Link>
                          </li>
            ...
            <div className="col-lg-3">
              ...
              {/* <div className="widget widget-tags">
                ...
                <ul className="list-inline widget-list widget-list-inline taxonomies-list">
                  <li className="list-inline-item">
                    <Link to="#!">Booth</Link>
                  </li>
                  <li className="list-inline-item">
